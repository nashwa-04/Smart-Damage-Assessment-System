...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <?php if(app()->environment('production')): ?>
            <link rel="stylesheet" href="<?php echo e(asset('build/assets/app-Br3j1D5Y.css')); ?>">
            <script src="<?php echo e(asset('build/assets/app-BXS-Op9n.js')); ?>" defer></script>
        <?php else: ?>
...
<?php /**PATH D:\Smart Damage Assessment System\backend\resources\views/layouts/guest.blade.php ENDPATH**/ ?>