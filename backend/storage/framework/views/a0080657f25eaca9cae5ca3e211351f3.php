        ...
        reports.forEach(report => {
            ...
            if (report.images && report.images.length > 0) {
                ...
                report.images.forEach(img => {
                    const imageUrl = '<?php echo e(asset("storage")); ?>/' + img;
                ...
                // دعم الصورة القديمة
                const imageUrl = '<?php echo e(asset("storage")); ?>/' + report.image_path;
            ...
            // عرض ملف PDF
            if (report.pdf_file) {
                const pdfUrl = '<?php echo e(asset("storage")); ?>/' + report.pdf_file;
...
<?php /**PATH D:\Smart Damage Assessment System\backend\resources\views/admin/map.blade.php ENDPATH**/ ?>