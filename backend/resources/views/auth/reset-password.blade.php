...
<head>
    ...
    <title>إعادة تعيين كلمة المرور - نظام تقييم الأضرار</title>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-1">{{ __('Reset Password') }}</h2>
                    <p class="text-charcoal/70 text-sm">{{ __('Enter a new password for your account') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-charcoal mb-1.5">{{ __('Password') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-charcoal mb-1.5">{{ __('Confirm Password') }}</label>
