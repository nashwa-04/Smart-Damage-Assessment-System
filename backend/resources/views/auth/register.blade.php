        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="flex items-center gap-1 sm:gap-2">
                    ...
                    <a href="{{ route('login') }}" class="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white rounded-lg transition-all" style="background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-1" data-ar="إنشاء حساب جديد" data-en="Create Account">إنشاء حساب جديد</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required autofocus
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="أدخل اسمك الكامل" data-ar-placeholder="أدخل اسمك الكامل" data-en-placeholder="Enter your full name">
                        </div>
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="example@email.com" data-ar-placeholder="example@email.com" data-en-placeholder="example@email.com">
                        </div>
                        <div>
                        ...
                        <button type="submit" class="w-full py-3 sm:py-3.5 btn-primary font-bold rounded-xl text-sm sm:text-base" data-ar="إنشاء الحساب" data-en="Create Account">
                            إنشاء الحساب
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('admin.register') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            <svg class="w-4 h-4 text-sand" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                            <span class="truncate" data-ar="حساب أدمن" data-en="Admin Account">حساب أدمن</span>
                        </a>
                        <a href="{{ route('login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
