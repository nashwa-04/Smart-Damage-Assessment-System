...
<a href="{{ route('login') }}" class="px-5 py-2.5 text-sm font-medium text-charcoal bg-light/90 hover:bg-light rounded-xl transition-all">
تسجيل الدخول
</a>
</div>
</div>
...
<div class="w-20 h-20 bg-gradient-to-br from-sand to-sage rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-xl">
<svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
</svg>
</div>
<h2 class="text-3xl font-black text-charcoal mb-2">إنشاء حساب جديد</h2>
<p class="text-charcoal/70">انضم إلينا للمساعدة في تقييم الأضرار</p>
</div>
...
<div class="space-y-5">
<div>
<label class="block text-sm font-semibold text-charcoal mb-2">الاسم الكامل</label>
<input type="text" name="name" value="{{ old('name') }}" required autofocus
class="w-full px-4 py-3.5 input-modern rounded-xl" placeholder="أدخل اسمك الكامل">
</div>
<div>
...
<div>
<label class="block text-sm font-semibold text-charcoal mb-2">تأكيد كلمة المرور</label>
...
<a href="{{ route('admin.register') }}" class="flex items-center justify-center gap-2 py-3 px-4 bg-charcoal/5 hover:bg-charcoal/10 rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-sm font-medium border border-charcoal/10">
<svg class="w-5 h-5 text-sand" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
</svg>
<span>حساب أدمن</span>
</a>
<a href="{{ route('login') }}" class="flex items-center justify-center gap-2 py-3 px-4 bg-charcoal/5 hover:bg-charcoal/10 rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-sm font-medium border border-charcoal/10">
