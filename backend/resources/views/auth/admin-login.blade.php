        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="flex items-center gap-1 sm:gap-2">
                    ...
                    <a href="{{ route('admin.register') }}" class="btn-primary px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold rounded-lg" data-ar="إنشاء حساب أدمن" data-en="Admin Register">إنشاء حساب أدمن</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-1" data-ar="تسجيل دخول الأدمن" data-en="Admin Login">تسجيل دخول الأدمن</h2>
                    <p class="text-charcoal/70 text-sm" data-ar="لوحة تحكم المسؤولين" data-en="Admin Control Panel">لوحة تحكم المسؤولين</p>
                </div>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            ...
                            <span class="truncate" data-ar="دخول المستخدم" data-en="User Login">دخول المستخدم</span>
                        </a>
