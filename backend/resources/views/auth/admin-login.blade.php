        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.register') }}" class="btn-primary px-4 py-1.5 text-xs font-semibold rounded-lg" data-ar="إنشاء حساب أدمن" data-en="Admin Register">إنشاء حساب أدمن</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-8 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-black text-charcoal mb-1" data-ar="تسجيل دخول الأدمن" data-en="Admin Login">تسجيل دخول الأدمن</h2>
