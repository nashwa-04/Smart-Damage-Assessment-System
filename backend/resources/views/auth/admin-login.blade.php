...
<a href="{{ route('admin.register') }}" class="btn-primary px-6 py-2.5 text-sm font-semibold rounded-xl">
إنشاء حساب أدمن
</a>
</div>
</div>
...
<div class="w-20 h-20 bg-gradient-to-br from-charcoal to-sage rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-xl">
<svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
</svg>
</div>
<h2 class="text-3xl font-black text-charcoal mb-2">تسجيل دخول الأدمن</h2>
<p class="text-charcoal/70">لوحة تحكم المسؤولين</p>
</div>
...
class="w-full px-4 py-3.5 input-modern rounded-xl" placeholder="admin@example.com">
</div>
<div>
