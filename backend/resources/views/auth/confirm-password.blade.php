...
<head>
    ...
    <title>تأكيد كلمة المرور - نظام تقييم الأضرار</title>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-2">{{ __('Confirm Password') }}</h2>
                    <p class="text-charcoal/70 text-sm leading-relaxed">{{ __('This is a secure area of the application. Please confirm your password before continuing.') }}</p>
                </div>
