            ...
            <div class="flex justify-between items-center h-14 sm:h-16">
                <div class="flex items-center gap-2 sm:gap-3">
                    <a href="{{ route('home') }}" class="flex items-center gap-2 sm:gap-3">
                        ...
                        <span class="text-xs sm:text-sm font-bold text-light leading-tight" data-ar="نظام تقييم الأضرار" data-en="Damage Assessment">نظام تقييم الأضرار</span>
                    </a>
                </div>
                <div class="flex items-center gap-1 sm:gap-2">
                    <button id="langToggle" class="flex items-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm text-white/70 hover:text-white rounded-lg transition-all" style="background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.15);">
                    ...
                    <a href="{{ route('home') }}" class="text-white/80 hover:text-white transition-colors text-xs sm:text-sm font-medium px-3 py-1.5 sm:px-4 sm:py-2" data-ar="الرئيسية" data-en="Home">الرئيسية</a>
                    <a href="{{ route('admin.login') }}" class="btn-primary px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold rounded-lg" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-sand to-sage rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl">
                        <svg class="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                    </div>
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-1" data-ar="إنشاء حساب أدمن" data-en="Create Admin Account">إنشاء حساب أدمن</h2>
                    <p class="text-charcoal/70 text-sm" data-ar="انضم كمسؤول في النظام" data-en="Join as a system administrator">انضم كمسؤول في النظام</p>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required autofocus
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="أدخل اسمك الكامل">
                        </div>
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="admin@example.com">
                        </div>
                        <div>
                            ...
                            <input type="password" name="password" required
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="••••••••">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-charcoal mb-1.5" data-ar="رمز الأدمن السري" data-en="Admin Secret Code">رمز الأدمن السري</label>
                            <input type="text" name="admin_code" required
                                class="w-full px-4 py-2.5 sm:py-3 input-modern rounded-xl" placeholder="أدخل رمز الأدمن">
                            <p class="text-xs text-charcoal/50 mt-1" data-ar="مطلوب رمز خاص لإنشاء حساب أدمن" data-en="A special code is required to create an admin account">مطلوب رمز خاص لإنشاء حساب أدمن</p>
                        </div>
                        <button type="submit" class="w-full py-3 sm:py-3.5 btn-primary font-bold rounded-xl text-sm sm:text-base" data-ar="إنشاء حساب الأدمن" data-en="Create Admin Account">
                            إنشاء حساب الأدمن
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('register') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            <svg class="w-4 h-4 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            <span class="truncate" data-ar="حساب مستخدم" data-en="User Account">حساب مستخدم</span>
                        </a>
                        <a href="{{ route('admin.login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            <span class="truncate" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</span>
                        </a>
                    </div>
                </div>
            </div>
