...
<a href="{{ route('admin.login') }}" class="btn-primary px-6 py-2.5 text-sm font-semibold rounded-xl">
تسجيل الدخول
</a>
</div>
</div>
...
<div class="w-20 h-20 bg-gradient-to-br from-charcoal to-sand rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-xl">
<svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
</svg>
</div>
<h2 class="text-3xl font-black text-charcoal mb-2">إنشاء حساب أدمن</h2>
<p class="text-charcoal/70">انضم كمسؤول في النظام</p>
</div>
...
<div>
<label class="block text-sm font-semibold text-charcoal mb-2">رمز الأدمن السري</label>
<input type="text" name="admin_code" required
class="w-full px-4 py-3.5 input-modern rounded-xl" placeholder="أدخل رمز الأدمن">
<p class="text-xs text-charcoal/50 mt-1">مطلوب رمز خاص لإنشاء حساب أدمن</p>
</div>
