        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.login') }}" class="btn-primary px-4 py-1.5 text-xs font-semibold rounded-lg" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-8 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-black text-charcoal mb-1" data-ar="إنشاء حساب أدمن" data-en="Create Admin Account">إنشاء حساب أدمن</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required
                                class="w-full px-4 py-3 input-modern rounded-xl" placeholder="admin@example.com">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="admin_code" required
                                class="w-full px-4 py-3 input-modern rounded-xl" placeholder="أدخل رمز الأدمن">
                        ...
                        <button type="submit" class="w-full py-3.5 btn-primary font-bold rounded-xl text-base" data-ar="إنشاء حساب الأدمن" data-en="Create Admin Account">
                            إنشاء حساب الأدمن
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('register') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-sm font-medium hover:shadow-md">
                        ...
                        <a href="{{ route('admin.login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-sm font-medium hover:shadow-md">
