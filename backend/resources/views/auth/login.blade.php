        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('register') }}" class="btn-primary px-4 py-1.5 text-xs font-semibold rounded-lg" data-ar="إنشاء حساب" data-en="Register">إنشاء حساب</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-8 shadow-2xl">
                <div class="text-center mb-6">
                    <div class="w-16 h-16 bg-gradient-to-br from-sage to-sand rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </div>
                    <h2 class="text-2xl font-black text-charcoal mb-1" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</h2>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full py-3.5 btn-primary font-bold rounded-xl text-base" data-ar="تسجيل الدخول" data-en="Login">
                            تسجيل الدخول
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('admin.login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-sm font-medium hover:shadow-md">
                            ...
                            <span data-ar="دخول الأدمن" data-en="Admin Login">دخول الأدمن</span>
                        </a>
