        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="flex items-center gap-1 sm:gap-2">
                    ...
                    <a href="{{ route('register') }}" class="btn-primary px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold rounded-lg" data-ar="إنشاء حساب" data-en="Register">إنشاء حساب</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="glass rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-black text-charcoal mb-1" data-ar="تسجيل الدخول" data-en="Login">تسجيل الدخول</h2>
                    <p class="text-charcoal/70 text-sm" data-ar="أدخل بياناتك للوصول إلى حسابك" data-en="Enter your credentials to access your account">أدخل بياناتك للوصول إلى حسابك</p>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ms-2 text-sm text-charcoal/70" data-ar="تذكرني" data-en="Remember me">تذكرني</span>
                            </label>
                            @if(Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-sand hover:text-sage transition-colors font-medium" data-ar="نسيت كلمة المرور؟" data-en="Forgot password?">
                                نسيت كلمة المرور؟
                            </a>
                            @endif
                        </div>
                        <button type="submit" class="w-full py-3 sm:py-3.5 btn-primary font-bold rounded-xl text-sm sm:text-base" data-ar="تسجيل الدخول" data-en="Login">
                            تسجيل الدخول
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 pt-5 border-t border-charcoal/10">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="{{ route('admin.login') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            ...
                            <span class="truncate" data-ar="دخول الأدمن" data-en="Admin Login">دخول الأدمن</span>
                        </a>
                        <a href="{{ route('register') }}" class="flex items-center justify-center gap-2 py-2.5 px-3 glass-light rounded-xl text-charcoal/70 hover:text-charcoal transition-all text-xs sm:text-sm font-medium hover:shadow-md">
                            ...
                            <span class="truncate" data-ar="إنشاء حساب" data-en="Register">إنشاء حساب</span>
                        </a>
                    </div>
                </div>
            </div>
